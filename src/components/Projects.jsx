...
const Projects = () => {
  return (
    <section className="relative flex gap-10 flex-col h-screen md:h-screen justify-start items-center pt-40 bg-gradient-to-b from-secondary to-[#9fb0d2] dark:from-[#232323] dark:to-[#232323]">
      ...
      <ScrollButton pageNo={4} isLight={true} />
    </section>
  );
};
